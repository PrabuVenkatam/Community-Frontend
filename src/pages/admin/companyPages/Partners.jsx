    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6">
          {filteredCompanies.map((company) => {
            ...
            return (
              <div
                key={company._id}
                className="group relative bg-white rounded-[24px] border border-gray-200/80 shadow-xs hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden flex flex-col justify-between hover:border-[#171717]/40"
              >
                <div>
                  {/* Top Cover Banner */}
      ...
      {selectedCompany &&
        createPortal(
          ...
          >
          <div
            className="bg-white w-full max-w-xl rounded-[28px] overflow-hidden shadow-2xl border border-gray-100 p-6 md:py-3 px-3 md:px-8 relative my-auto space-y-6"
          ...
          >
            ...
            <button
              type="button"
              onClick={() => setSelectedCompany(null)}
              className="absolute top-6 md:top-9 right-6 md:right-8 text-gray-400 hover:text-gray-800 bg-gray-100 hover:bg-gray-200 p-2 rounded-full transition-colors cursor-pointer"
            >
              <X size={18} />
            </button>
            ...
            {/* Key Information Summary Grid (Container Removed) */}
            ...
            <div className="pt-3 border-t border-gray-100 flex items-center justify-between gap-3">
              ...
              <button
                type="button"
                onClick={() => setSelectedCompany(null)}
                className="px-10 py-2 bg-[#171717] hover:bg-black text-white text-sm font-bold rounded-full transition-colors cursor-pointer"
              >
                Close
              </button>
            </div>
